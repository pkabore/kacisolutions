...
<template>
    <article>
        <transition appear enter-from-class="opacity-0 translate-y-10" enter-to-class="opacity-100 translate-y-0"
            enter-active-class="transition duration-300 ease-in-out" leave-active-class="transition duration-75 ease-in"
            leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-10">
            <div class="items-center justify-center h-full px-10 py-4 md:flex">
                <div class="mx-auto p-4 md:w-2/3">
                    <HeroSectionMessage />
                </div>
                <svg class="w-full p-8 md:w-1/3" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                    viewBox="0 0 863 826.71426" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <path
                        ...
                        transform="translate(-168.5 -36.64287)" opacity="0.1" />
                    <rect x="413.82432" y="145.67179" width="304.18032" height="211.88475" rx="10.6948"
                        fill="#3f3d56" />
                    ...
                    <path
                        ...
                        transform="translate(-168.5 -36.64287)" fill="#6c63ff" />
                    <path
                    ...
                    <path
                        d="M362.4444,363.35713l-6.02314,10.4315-6.02315-10.4315H330.34252l26.07874,45.17047L382.5,363.35713Z"
                        transform="translate(-168.5 -36.64287)" fill="#4dba87" />
                    <path
                        d="M362.4444,363.35713l-6.02314,10.4315-6.02315-10.4315H340.774l15.64724,27.101,15.64724-27.101Z"
        ...
        <transition appear enter-from-class="opacity-0 translate-y-10" enter-to-class="opacity-100 translate-y-0"
            enter-active-class="transition duration-300 ease-in-out" leave-active-class="transition duration-75 ease-in"
            leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-10">
            <div class="h-full justify-center p-4 pt-0 md:grid grid-flow-row grid-cols-3 gap-4 md:p-10">
                <Card v-for="item in items" :key="item.id" :item="item" class="mt-10 first:mt-0 md:mt-0" />
            </div>
        </transition>
    </article>
</template>